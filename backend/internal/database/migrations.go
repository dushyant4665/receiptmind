...
func RunMigrations(ctx context.Context, db *Database) error {
	migrations := []string{
		...
		`ALTER TABLE exceptions ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP WITH TIME ZONE`,
		...
		`ALTER TABLE subscriptions ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP WITH TIME ZONE`,
		`ALTER TABLE google_integrations ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP WITH TIME ZONE`,
		`ALTER TABLE storage_objects ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP WITH TIME ZONE`,
		`ALTER TABLE vendor_aliases ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP WITH TIME ZONE`,
		`ALTER TABLE receipt_processing_jobs ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP WITH TIME ZONE`,
